...
/* MT6877 has multiple bases to program pin configuration. */
static const char * const mt6877_pinctrl_register_base_names[] = {
	"iocfg0", "iocfg_rm", "iocfg_rb", "iocfg_bm", "iocfg_bl", "iocfg_br",
	"iocfg_lm", "iocfg_rt", "iocfg_tl",
};
...
static const struct mtk_pin_soc mt6877_data = {
	...
	.base_names = mt6877_pinctrl_register_base_names,
	.nbase_names = ARRAY_SIZE(mt6877_pinctrl_register_base_names),
