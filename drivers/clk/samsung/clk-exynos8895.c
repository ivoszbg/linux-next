...
#define CLKS_NR_CORE	(CLK_GOUT_CORE_TREX_P1_CORE_PCLK_CORE + 1)
...
static const struct samsung_mux_clock top_mux_clks[] __initconst = {
	...
	MUX(CLK_MOUT_CMU_CLK_CMU_CMUREF, "mout_cmu_clk_cmu_cmuref",
	    mout_clk_cmu_cmuref_p, CLK_CON_MUX_MUX_CLK_CMU_CMUREF, 0, 1),
...
static const struct samsung_div_clock top_div_clks[] __initconst = {
	DIV(CLK_DOUT_CMU_SHARED0_DIV2, "dout_cmu_shared0_div2",
	    "mout_pll_shared0", CLK_CON_DIV_DIV_PLL_SHARED0_DIV2, 0, 1),
	DIV(CLK_DOUT_CMU_SHARED0_DIV4, "dout_cmu_shared0_div4",
	    "dout_cmu_shared0_div2", CLK_CON_DIV_DIV_PLL_SHARED0_DIV4, 0, 1),
	DIV(CLK_DOUT_CMU_SHARED1_DIV2, "dout_cmu_shared1_div2",
	    "mout_pll_shared1", CLK_CON_DIV_DIV_PLL_SHARED1_DIV2, 0, 1),
	DIV(CLK_DOUT_CMU_SHARED1_DIV4, "dout_cmu_shared1_div4",
	    "dout_cmu_shared1_div2", CLK_CON_DIV_DIV_PLL_SHARED1_DIV4, 0, 1),
	DIV(CLK_DOUT_CMU_SHARED2_DIV2, "dout_cmu_shared2_div2",
	    "mout_pll_shared2", CLK_CON_DIV_DIV_PLL_SHARED2_DIV2, 0, 1),
	DIV(CLK_DOUT_CMU_SHARED3_DIV2, "dout_cmu_shared3_div2",
	    "mout_pll_shared3", CLK_CON_DIV_DIV_PLL_SHARED3_DIV2, 0, 1),
	DIV(CLK_DOUT_CMU_SHARED4_DIV2, "dout_cmu_shared4_div2",
	    "mout_pll_shared4", CLK_CON_DIV_DIV_PLL_SHARED4_DIV2, 0, 1),
...
static const struct samsung_gate_clock top_gate_clks[] __initconst = {
	...
	GATE(CLK_GOUT_CMU_DCAM_IMGD, "gout_cmu_dcam_imgd", "mout_cmu_dcam_imgd",
	     CLK_CON_GAT_GATE_CLKCMU_DCAM_IMGD, 21, 0, 0),
...
PNAME(mout_mux_clk_peris_gic_p)	= { "oscclk", "mout_peris_bus_user" };

static const struct samsung_mux_clock peris_mux_clks[] __initconst = {
	MUX(CLK_MOUT_PERIS_BUS_USER, "mout_peris_bus_user",
	    mout_peris_bus_user_p, PLL_CON0_MUX_CLKCMU_PERIS_BUS_USER, 4, 1),
	MUX(CLK_MOUT_MUX_CLK_PERIS_GIC, "mout_mux_clk_peris_gic",
	    mout_mux_clk_peris_gic_p, CLK_CON_MUX_MUX_CLK_PERIS_GIC, 0, 5),
};
...
static const struct samsung_gate_clock peris_gate_clks[] __initconst = {
	...
	GATE(CLK_GOUT_PERIS_AD_AXI_P_PERIS_ACLKM,
	     "gout_peris_ad_axi_p_peris_aclkm", "mout_mux_clk_peris_gic",
	     CLK_CON_GAT_GOUT_BLK_PERIS_UID_AD_AXI_P_PERIS_IPCLKPORT_ACLKM,
	     21, CLK_IS_CRITICAL, 0),
	...
	GATE(CLK_GOUT_PERIS_RSTNSYNC_CLK_PERIS_GIC_CLK,
	     "gout_peris_rstnsync_clk_peris_gic_clk", "mout_mux_clk_peris_gic",
	     CLK_CON_GAT_GOUT_BLK_PERIS_UID_RSTNSYNC_CLK_PERIS_GIC_IPCLKPORT_CLK,
	     21, 0, 0),
...
/* Register Offset definitions for CMU_CORE (0x15810000) */
...
#define CLK_CON_GAT_CLK_BLK_CORE_UID_HPM_CORE_IPCLKPORT_HPM_TARGETCLK_C		0x2004
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_ADM_APB_G_BDU_IPCLKPORT_PCLKM		0x2018
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_APBBR_CCI_IPCLKPORT_PCLK			0x201c
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_AXI2APB_CORE_IPCLKPORT_ACLK		0x2020
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_AXI2APB_CORE_TP_IPCLKPORT_ACLK		0x2024
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_BDU_IPCLKPORT_I_CLK			0x2028
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_BDU_IPCLKPORT_I_PCLK			0x202c
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_BUSIF_HPMCORE_IPCLKPORT_PCLK		0x2030
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_CCI_IPCLKPORT_CLK				0x2034
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_CCI_IPCLKPORT_PCLK			0x2038
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_LHM_ACE_D0_G3D_IPCLKPORT_I_CLK		0x203c
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_LHM_ACE_D1_G3D_IPCLKPORT_I_CLK		0x2040
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_LHM_ACE_D2_G3D_IPCLKPORT_I_CLK		0x2044
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_LHM_ACE_D3_G3D_IPCLKPORT_I_CLK		0x2048
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_LHM_ACE_D_CPUCL1_IPCLKPORT_I_CLK		0x204c
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_LHM_AXI_D_CP_IPCLKPORT_I_CLK		0x2050
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_LHM_AXI_P_CP_IPCLKPORT_I_CLK		0x2054
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_LHM_CPACE_D_CPUCL0_IPCLKPORT_I_CLK	0x2058
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_LHM_DBG_G0_DMC_IPCLKPORT_I_CLK		0x205c
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_LHM_DBG_G1_DMC_IPCLKPORT_I_CLK		0x2060
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_LHM_DBG_G2_DMC_IPCLKPORT_I_CLK		0x2064
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_LHM_DBG_G3_DMC_IPCLKPORT_I_CLK		0x2068
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_LHS_ATB_T_BDU_IPCLKPORT_I_CLK		0x206c
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_LHS_AXI_P_CPUCL0_IPCLKPORT_I_CLK		0x2070
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_LHS_AXI_P_CPUCL1_IPCLKPORT_I_CLK		0x2074
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_LHS_AXI_P_DBG_IPCLKPORT_I_CLK		0x2078
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_LHS_AXI_P_G3D_IPCLKPORT_I_CLK		0x207c
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_LHS_AXI_P_IMEM_IPCLKPORT_I_CLK		0x2080
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_LHS_PSCDC_D_MIF0_IPCLKPORT_I_CLK		0x2084
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_LHS_PSCDC_D_MIF1_IPCLKPORT_I_CLK		0x2088
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_LHS_PSCDC_D_MIF2_IPCLKPORT_I_CLK		0x208c
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_LHS_PSCDC_D_MIF3_IPCLKPORT_I_CLK		0x2090
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_MPACE2AXI_0_IPCLKPORT_CLK			0x2094
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_MPACE2AXI_1_IPCLKPORT_CLK			0x2098
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_PMU_CORE_IPCLKPORT_PCLK			0x209c
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_PPCFW_G3D_IPCLKPORT_ACLK			0x20a0
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_PPCFW_G3D_IPCLKPORT_PCLK			0x20a4
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_BCMPPC_CCI_IPCLKPORT_ACLK			0x20a8
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_BCMPPC_CCI_IPCLKPORT_PCLK			0x20ac
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_BCM_CPUCL0_IPCLKPORT_ACLK			0x20b0
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_BCM_CPUCL0_IPCLKPORT_PCLK			0x20b4
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_BCM_CPUCL1_IPCLKPORT_ACLK			0x20b8
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_BCM_CPUCL1_IPCLKPORT_PCLK			0x20bc
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_BCM_G3D0_IPCLKPORT_ACLK			0x20c0
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_BCM_G3D0_IPCLKPORT_PCLK			0x20c4
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_BCM_G3D1_IPCLKPORT_ACLK			0x20c8
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_BCM_G3D1_IPCLKPORT_PCLK			0x20cc
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_BCM_G3D2_IPCLKPORT_ACLK			0x20d0
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_BCM_G3D2_IPCLKPORT_PCLK			0x20d4
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_BCM_G3D3_IPCLKPORT_ACLK			0x20d8
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_BCM_G3D3_IPCLKPORT_PCLK			0x20dc
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_RSTNSYNC_CLK_CORE_BUSD_IPCLKPORT_CLK	0x20e0
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_RSTNSYNC_CLK_CORE_BUSP_IPCLKPORT_CLK	0x20e4
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_SYSREG_CORE_IPCLKPORT_PCLK		0x20e8
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_TREX_D_CORE_IPCLKPORT_ACLK		0x20ec
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_TREX_D_CORE_IPCLKPORT_PCLK		0x20f0
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_TREX_P0_CORE_IPCLKPORT_ACLK_CORE		0x20f4
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_TREX_P0_CORE_IPCLKPORT_PCLK		0x20f8
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_TREX_P0_CORE_IPCLKPORT_PCLK_CORE		0x20fc
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_TREX_P1_CORE_IPCLKPORT_PCLK		0x2100
#define CLK_CON_GAT_GOUT_BLK_CORE_UID_TREX_P1_CORE_IPCLKPORT_PCLK_CORE		0x2104
...
PNAME(mout_core_bus_user_p) = { "oscclk", "dout_cmu_core_bus" };
...
static const struct samsung_gate_clock core_gate_clks[] __initconst = {
	GATE(CLK_GOUT_CORE_CORE_CMU_CORE_PCLK, "gout_core_core_cmu_core_pclk",
	     "dout_core_busp",
	     CLK_CON_GAT_CLK_BLK_CORE_UID_CORE_CMU_CORE_IPCLKPORT_PCLK,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_CORE_HPM_CORE_HPM_TARGETCLK_C,
	     "gout_core_hpm_core_hpm_targetclk_c", "dout_cmu_hpm",
	     CLK_CON_GAT_CLK_BLK_CORE_UID_HPM_CORE_IPCLKPORT_HPM_TARGETCLK_C,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_ADM_APB_G_BDU_PCLKM,
	     "gout_core_adm_apb_g_bdu_pclkm", "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_ADM_APB_G_BDU_IPCLKPORT_PCLKM,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_APBBR_CCI_PCLK, "gout_core_apbbr_cci_pclk",
	     "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_APBBR_CCI_IPCLKPORT_PCLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_AXI2APB_CORE_ACLK, "gout_core_axi2apb_core_aclk",
	     "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_AXI2APB_CORE_IPCLKPORT_ACLK,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_CORE_AXI2APB_CORE_TP_ACLK,
	     "gout_core_axi2apb_core_tp_aclk", "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_AXI2APB_CORE_TP_IPCLKPORT_ACLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_BDU_I_CLK, "gout_core_bdu_i_clk",
	     "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_BDU_IPCLKPORT_I_CLK,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_CORE_BDU_I_PCLK, "gout_core_bdu_i_pclk",
	     "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_BDU_IPCLKPORT_I_PCLK,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_CORE_BUSIF_HPMCORE_PCLK, "gout_core_busif_hpmcore_pclk",
	     "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_BUSIF_HPMCORE_IPCLKPORT_PCLK,
	     21, 0, 0),
	...
	GATE(CLK_GOUT_CORE_CCI_PCLK, "gout_core_cci_pclk", "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_CCI_IPCLKPORT_PCLK,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_CORE_LHM_ACE_D0_G3D_I_CLK,
	     "gout_core_lhm_ace_d0_g3d_i_clk", "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_LHM_ACE_D0_G3D_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_LHM_ACE_D1_G3D_I_CLK,
	     "gout_core_lhm_ace_d1_g3d_i_clk", "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_LHM_ACE_D1_G3D_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_LHM_ACE_D2_G3D_I_CLK,
	     "gout_core_lhm_ace_d2_g3d_i_clk", "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_LHM_ACE_D2_G3D_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_LHM_ACE_D3_G3D_I_CLK,
	     "gout_core_lhm_ace_d3_g3d_i_clk", "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_LHM_ACE_D3_G3D_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_LHM_ACE_D_CPUCL1_I_CLK,
	     "gout_core_lhm_ace_d_cpucl1_i_clk", "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_LHM_ACE_D_CPUCL1_IPCLKPORT_I_CLK,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_CORE_LHM_AXI_D_CP_I_CLK,
	     "gout_core_lhm_axi_d_cp_i_clk", "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_LHM_AXI_D_CP_IPCLKPORT_I_CLK, 
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_LHM_AXI_P_CP_I_CLK,
	     "gout_core_lhm_axi_p_cp_i_clk", "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_LHM_AXI_P_CP_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_LHM_CPACE_D_CPUCL0_I_CLK,
	     "gout_core_lhm_cpace_d_cpucl0_i_clk", "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_LHM_CPACE_D_CPUCL0_IPCLKPORT_I_CLK,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_CORE_LHM_DBG_G0_DMC_I_CLK,
	     "gout_core_lhm_dbg_g0_dmc_i_clk", "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_LHM_DBG_G0_DMC_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_LHM_DBG_G1_DMC_I_CLK,
	     "gout_core_lhm_dbg_g1_dmc_i_clk", "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_LHM_DBG_G1_DMC_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_LHM_DBG_G2_DMC_I_CLK,
	     "gout_core_lhm_dbg_g2_dmc_i_clk", "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_LHM_DBG_G2_DMC_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_LHM_DBG_G3_DMC_I_CLK,
	     "gout_core_lhm_dbg_g3_dmc_i_clk", "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_LHM_DBG_G3_DMC_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_LHS_ATB_T_BDU_I_CLK,
	     "gout_core_lhs_atb_t_bdu_i_clk", "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_LHS_ATB_T_BDU_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_LHS_AXI_P_CPUCL0_I_CLK,
	     "gout_core_lhs_axi_p_cpucl0_i_clk", "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_LHS_AXI_P_CPUCL0_IPCLKPORT_I_CLK,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_CORE_LHS_AXI_P_CPUCL1_I_CLK,
	     "gout_core_lhs_axi_p_cpucl1_i_clk", "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_LHS_AXI_P_CPUCL1_IPCLKPORT_I_CLK,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_CORE_LHS_AXI_P_DBG_I_CLK,
	     "gout_core_lhs_axi_p_dbg_i_clk", "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_LHS_AXI_P_DBG_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_LHS_AXI_P_G3D_I_CLK,
	     "gout_core_lhs_axi_p_g3d_i_clk", "dout_core_busp", 
	    CLK_CON_GAT_GOUT_BLK_CORE_UID_LHS_AXI_P_G3D_IPCLKPORT_I_CLK,
	    21, 0, 0),
	GATE(CLK_GOUT_CORE_LHS_AXI_P_IMEM_I_CLK,
	     "gout_core_lhs_axi_p_imem_i_clk", "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_LHS_AXI_P_IMEM_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_LHS_PSCDC_D_MIF0_I_CLK,
	     "gout_core_lhs_pscdc_d_mif0_i_clk", "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_LHS_PSCDC_D_MIF0_IPCLKPORT_I_CLK,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_CORE_LHS_PSCDC_D_MIF1_I_CLK,
	     "gout_core_lhs_pscdc_d_mif1_i_clk", "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_LHS_PSCDC_D_MIF1_IPCLKPORT_I_CLK,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_CORE_LHS_PSCDC_D_MIF2_I_CLK,
	     "gout_core_lhs_pscdc_d_mif2_i_clk", "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_LHS_PSCDC_D_MIF2_IPCLKPORT_I_CLK,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_CORE_LHS_PSCDC_D_MIF3_I_CLK,
	     "gout_core_lhs_pscdc_d_mif3_i_clk", "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_LHS_PSCDC_D_MIF3_IPCLKPORT_I_CLK,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_CORE_MPACE2AXI_0_CLK, "gout_core_mpace2axi_0_clk",
	     "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_MPACE2AXI_0_IPCLKPORT_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_MPACE2AXI_1_CLK, "gout_core_mpace2axi_1_clk",
	     "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_MPACE2AXI_1_IPCLKPORT_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_PMU_CORE_PCLK, "gout_core_pmu_core_pclk",
	     "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_PMU_CORE_IPCLKPORT_PCLK, 21, 0, 0),
	GATE(CLK_GOUT_CORE_PPCFW_G3D_ACLK, "gout_core_ppcfw_g3d_aclk",
	     "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_PPCFW_G3D_IPCLKPORT_ACLK, 21, 0, 0),
	GATE(CLK_GOUT_CORE_PPCFW_G3D_PCLK, "gout_core_ppcfw_g3d_pclk",
	     "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_PPCFW_G3D_IPCLKPORT_PCLK, 21, 0, 0),
	GATE(CLK_GOUT_CORE_BCMPPC_CCI_ACLK, "gout_core_bcmppc_cci_aclk",
	     "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_BCMPPC_CCI_IPCLKPORT_ACLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_BCMPPC_CCI_PCLK, "gout_core_bcmppc_cci_pclk",
	     "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_BCMPPC_CCI_IPCLKPORT_PCLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_BCM_CPUCL0_ACLK, "gout_core_bcm_cpucl0_aclk",
	     "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_BCM_CPUCL0_IPCLKPORT_ACLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_BCM_CPUCL0_PCLK, "gout_core_bcm_cpucl0_pclk",
	     "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_BCM_CPUCL0_IPCLKPORT_PCLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_BCM_CPUCL1_ACLK, "gout_core_bcm_cpucl1_aclk",
	     "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_BCM_CPUCL1_IPCLKPORT_ACLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_BCM_CPUCL1_PCLK, "gout_core_bcm_cpucl1_pclk",
	     "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_BCM_CPUCL1_IPCLKPORT_PCLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_BCM_G3D0_ACLK, "gout_core_bcm_g3d0_aclk",
	     "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_BCM_G3D0_IPCLKPORT_ACLK, 21, 0, 0),
	GATE(CLK_GOUT_CORE_BCM_G3D0_PCLK, "gout_core_bcm_g3d0_pclk",
	     "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_BCM_G3D0_IPCLKPORT_PCLK, 21, 0, 0),
	GATE(CLK_GOUT_CORE_BCM_G3D1_ACLK, "gout_core_bcm_g3d1_aclk",
	     "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_BCM_G3D1_IPCLKPORT_ACLK, 21, 0, 0),
	GATE(CLK_GOUT_CORE_BCM_G3D1_PCLK, "gout_core_bcm_g3d1_pclk",
	     "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_BCM_G3D1_IPCLKPORT_PCLK, 21, 0, 0),
	GATE(CLK_GOUT_CORE_BCM_G3D2_ACLK, "gout_core_bcm_g3d2_aclk",
	     "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_BCM_G3D2_IPCLKPORT_ACLK, 21, 0, 0),
	GATE(CLK_GOUT_CORE_BCM_G3D2_PCLK, "gout_core_bcm_g3d2_pclk",
	     "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_BCM_G3D2_IPCLKPORT_PCLK, 21, 0, 0),
	GATE(CLK_GOUT_CORE_BCM_G3D3_ACLK, "gout_core_bcm_g3d3_aclk",
	     "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_BCM_G3D3_IPCLKPORT_ACLK, 21, 0, 0),
	GATE(CLK_GOUT_CORE_BCM_G3D3_PCLK, "gout_core_bcm_g3d3_pclk",
	     "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_BCM_G3D3_IPCLKPORT_PCLK, 21, 0, 0),
	GATE(CLK_GOUT_CORE_RSTNSYNC_CLK_CORE_BUSD_CLK,
	     "gout_core_rstnsync_clk_core_busd_clk", "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_RSTNSYNC_CLK_CORE_BUSD_IPCLKPORT_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_RSTNSYNC_CLK_CORE_BUSP_CLK,
	     "gout_core_rstnsync_clk_core_busp_clk", "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_RSTNSYNC_CLK_CORE_BUSP_IPCLKPORT_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_SYSREG_CORE_PCLK, "gout_core_sysreg_core_pclk",
	     "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_SYSREG_CORE_IPCLKPORT_PCLK,
	     21, 0, 0),
	GATE(CLK_GOUT_CORE_TREX_D_CORE_ACLK, "gout_core_trex_d_core_aclk",
	     "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_TREX_D_CORE_IPCLKPORT_ACLK,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_CORE_TREX_D_CORE_PCLK, "gout_core_trex_d_core_pclk",
	     "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_TREX_D_CORE_IPCLKPORT_PCLK,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_CORE_TREX_P0_CORE_ACLK_CORE,
	     "gout_core_trex_p0_core_aclk_core", "mout_core_bus_user",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_TREX_P0_CORE_IPCLKPORT_ACLK_CORE,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_CORE_TREX_P0_CORE_PCLK, "gout_core_trex_p0_core_pclk",
	     "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_TREX_P0_CORE_IPCLKPORT_PCLK,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_CORE_TREX_P0_CORE_PCLK_CORE,
	     "gout_core_trex_p0_core_pclk_core", "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_TREX_P0_CORE_IPCLKPORT_PCLK_CORE,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_CORE_TREX_P1_CORE_PCLK, "gout_core_trex_p1_core_pclk",
	     "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_TREX_P1_CORE_IPCLKPORT_PCLK,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_CORE_TREX_P1_CORE_PCLK_CORE,
	     "gout_core_trex_p1_core_pclk_core", "dout_core_busp",
	     CLK_CON_GAT_GOUT_BLK_CORE_UID_TREX_P1_CORE_IPCLKPORT_PCLK_CORE,
	     21, CLK_IS_CRITICAL, 0),
};
...
static const struct of_device_id exynos8895_cmu_of_match[] = {
	{
		.compatible = "samsung,exynos8895-cmu-core",
		.data = &core_cmu_info,
	}, {
